...
![[Pasted image 20250720191015.png]]The above diagram illustrates this, showing "State" at the top and "Props" being passed down through many layers of components to a deeply nested one.
![[Pasted image 20250720205846.png]]
...
![[Pasted image 20250720205905.png]]


### 7.   Implicit State
![[Pasted image 20250720210403.png]]
...
ReactDOM.createRoot(document.getElementById('root')).render(<App />);
```
![[Pasted image 20250723190149.png]]
![[Pasted image 20250723190203.png]]
...
### 14. Custom Hooks [^14]
- ![[Pasted image 20250818130755.png]]
...
---
## References
[^1]: [[Some instances where props.children is useful - React]]
[^3]: [[props de-structuring and its importance - React]]
[^5]: [[AHA Programming ]]
[^6]: [[Compound components - React]] 
[^8]: [[React.Children and React.cloneElement()]]
[^9]: [[React Context]]
[^10]: [[Compound components with dot syntax - React]]
[^11]: [[Headless Components - React]]
[^12]: [[useRef()- React]]
[^13]: [[Render props - React]]
[^14]: [[Custom hooks - React]]
[[React Router 6]]