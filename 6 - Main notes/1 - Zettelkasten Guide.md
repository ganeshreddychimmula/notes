...
- [[../5 - Templates/zTemplate - Guide]]: This folder has a single, straightforward purpose: to **store the template for your main notes**. Once set up, you generally won't need to interact with this folder directly. The template provides a basic structure that can be automatically pasted into new notes using a hotkey.
